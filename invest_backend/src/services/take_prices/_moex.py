...
def _take_board_id_moex(ticker: str) -> str:
    """Получение board_id актива для дальнейшего формирования ссылки, по которой возможно получить цену актива.
...
def take_price_moex(ticker: str, asset_class: str) -> str:
    ...
    :param ticker: тикер актива
    :param asset_class: класс актива, для определения url
    :return: цена актива
    """
